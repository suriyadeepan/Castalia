...
std::ostream & CastaliaModule::Topoinfos()
{
return (ostream &) Topology::getStream() <<
			"\n";
}

std::ostream & CastaliaModule::Mobinfos()
{
return (ostream &) Mobility::getStream() <<
			"\n" << setw(16) << simTime() << " ";
}

std::ostream & CastaliaModule::Cominfos()
{
	
return (ostream &) Com::getStream() <<
			"\n" << setw(16) << simTime() << " ";

}

std::ostream & CastaliaModule::Energyinfos()
{
	
return (ostream &) Energy::getStream() <<
			"\n" << setw(16) << simTime() << " ";

}

std::ostream & CastaliaModule::Macinfos()
{
	
return (ostream &) MacCom::getStream() <<
			"\n" << setw(16) << simTime() << " ";

}

std::ostream & CastaliaModule::Radioinfos()
{
	
return (ostream &) RadioCom::getStream() <<
			"\n" << setw(16) << simTime() << " ";

}

std::ostream & CastaliaModule::Appinfos()
{
	
return (ostream &) App::getStream() <<
			"\n" << setw(16) << simTime() << " ";

}

std::ostream & CastaliaModule::Statsinfos()
{
	
return (ostream &) Stats::getStream() <<
			"\n"  << (int)simTime().dbl() << " ";

}

std::ostream & CastaliaModule::NodeStatinfos()
{
	
return (ostream &) Stat::getStream() <<
			"\n"  << simTime() << " ";
