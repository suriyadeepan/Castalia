...
class CastaliaModule: public virtual cSimpleModule {
 ...
 protected:
	...
	std::ostream & trace();
	std::ostream & Topoinfos();
	std::ostream & Mobinfos();
	std::ostream & Cominfos();
	std::ostream & Energyinfos();
	std::ostream & Radioinfos();
	std::ostream & Macinfos();
	std::ostream & Appinfos();
	std::ostream & Statsinfos();
	std::ostream & NodeStatinfos();
	std::ostream & debug();
