...
void WirelessChannel::finishSpecific()
{
	...
	Topology::closeStream();
	Mobility::closeStream();
	Com::closeStream();
	Energy::closeStream();
	RadioCom::closeStream();
	MacCom::closeStream();
	App::closeStream();
	Stats::closeStream();
	Stat::closeStream();
...
void WirelessChannel::readIniFileParameters(void)
{
	...
	Topology::setDebugFileName("Topology.txt");
	Mobility::setDebugFileName("Mobility.txt");
	Com::setDebugFileName("RoutingCommunication.txt");
	Energy::setDebugFileName("Energy.txt");
	RadioCom::setDebugFileName("RadioCommunication.txt");
	MacCom::setDebugFileName("MacCommunication.txt");
	App::setDebugFileName("ApplicationData.txt");
	Stat::setDebugFileName("NodeStatus.txt");
	Stats::setDebugFileName("Packet_Received.txt");
